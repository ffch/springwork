...
public class DateUtil {
	...
	public static final String SimpleFullPattern = "yyyyMMddHHmmss";
	...
	public static String formatNow8() {
		return format(new Date(),SimpleDatePattern);
	}
	
	public static String formatNowFull() {
		return format(new Date(),SimpleFullPattern);
	}
	
	public static String formatNowTime6() {
		return format(new Date(),SimpleTimePattern);
	}
