	...
	<div>
		...
		<div class="nav-content" id="prof-content">
			...
			<br> <a class="qqconnect"
				href="${ctx}/jsp/suggestion/applylist.jsp">我的申请</a> <br> <br>
			<a class="qqconnect" href="${ctx}/jsp/suggestion/watinglist.jsp">我的待办</a><br> <br>
			<a class="qqconnect" href="${ctx}/jsp/suggestion/managelist.jsp">我的审批</a><br> <br>
		</div>
		...
		<div
			...
			<div id="lr_systembtn" class="lr_systembtn">
				...
				<div id="lr_menu" class="lr_menu">
					<dl>
						<dt>
							<a href="${ctx}/jsp/user/userManager.jsp" target="_blank">个人管理</a>
						</dt>
					</dl>
					<dl>
						<dt>
		...
		success : function(data) {
			...
			if(users != null && users.length != 0){
				...
				for (var i = 0; i < size; i++) {
					content += "<a class=\"qqconnect\" href=\"${ctx}/jsp/websocket/websocketchatcommon.jsp?specialUser="+ users[i].userName +"&num=" + (i+1) +"\">语聊客服"+users[i].userName+"<\/a><br><br>";
				}
